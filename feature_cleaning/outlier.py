# -*- coding: utf-8 -*-
"""
Created on Mon Dec 30 17:39:30 2024
...
def outlier_detect_arbitrary(data,col,upper_fence,lower_fence):
    ...
    print('Num of outlier detected:',outlier_index.value_counts().iloc[1])
    print('Proportion of outlier detected',outlier_index.value_counts().iloc[1]/len(outlier_index))    
