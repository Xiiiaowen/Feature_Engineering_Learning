# -*- coding: utf-8 -*-
"""
Created on Mon Dec 30 20:42:30 2024
...
# 2024.12.30 Created by Xiaowen.Shou
...
class GroupingRareValues():
    ...
    def fit(self, X, y = None, **kwargs):
        ...
        X: array-like, shape = [n_samples, n_features]
           ...
           and n_features us the number of features.
        y: array-like, shaore = [n_samples]
           Target velues.
        Returns
        -------
        self: encoder
    ...
    def transform(self, X):
        ...
        Will use the mapping (if available) and the column list to encode the data
        Parameters
        ----------
        X: array-like, shape = [n_samples, n_features]
        Returns
        ...
        if X.shape[1] != self.dim:
            raise ValueError('Unexpected input dimension %d, expected %d' % (X.shape[1], self.dim,))
